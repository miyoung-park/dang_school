					...
					<fieldset class="school_info_form">
						...
						<div id="separate_part">
							<div id="school_service">
								<p>제공서비스</p>
								<label for ="isKg"><input type = "checkbox" id = "isKg" value = "isKg"> 유치원</label><br>
								<input type = "checkbox" id = "isCafe" value = "isCafe"><label for = "isCafe"> 카페</label>	<br>
								<input type = "checkbox" id = "isHotel" value = "isHotel"><label for = "isHotel"> 호텔</label>	<br>
								<input type = "checkbox" id = "isPickup" value = "isPickup"><label for ="isPickup"> 픽업서비스</label><br>
								<input type = "checkbox" id = "isMedic" value = "isMedic"><label for = "isMedic"> 메니컬센터</label>	<br>
								<input type = "checkbox" id = "isAcademy" value = "isAcademy"><label for = "isAcademy"> 아카데미</label><br>
								<input type = "checkbox" id = "isSpa" value = "isSpa"><label for = "isSpa"> 스파</label>
							</div>
							<div id="school_photo">
								<p>유치원사진</p>
